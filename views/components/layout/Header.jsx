...
/*
      <header classNameName="lg:px-16 px-6 bg-gray-400 flex flex-wrap items-center lg:py-0 py-2">
        <div classNameName="flex-1 flex justify-between items-center">
          <a href="/">
            <img src="https://cdn.matievisthekat.dev/logo_1bQaVhA_n.png" alt="MatievisTheKat logo" classNameName="w-2/4" />
          </a>
        </div>

        <label htmlFor="menu-toggle" classNameName="pointer-cursor lg:hidden block">
          <svg
            classNameName="fill-current text-gray-900"
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
            viewBox="0 0 20 20"
        ...
        <input classNameName="lg:hidden" type="checkbox" id="menu-toggle" />

        <div classNameName="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
          <nav>
            <ul classNameName="lg:flex items-center justify-between text-base text-gray-700 pt-4 lg:pt-0">
              <li>
                <a classNameName="lg:p-4 py-3 px-0 block border-b-2 border-transparent hover:border-indigo-400" href="#">
                  Features
                </a>
              </li>
              <li>
