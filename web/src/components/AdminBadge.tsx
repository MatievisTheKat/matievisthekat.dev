...
const AdminBadge: React.FC<Props> = ({ width, className }) => {
  return (
    <Tooltip title="This user is a site admin" arrow>
      <span className={`inline-block p-1 ${className}`}>
        <svg
          id="Capa_1"
